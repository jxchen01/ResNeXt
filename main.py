...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        need_hour, need_mins, need_secs = convert_secs2time(epoch_time.avg * (args.epochs-args.start_epoch))
        ...
        top1_acc = validate(test_loader, net, criterion, log)

        # remember best prec@1 and save checkpoint
        is_best = top1_acc > best_accuracy
        best_accuracy = max(top1_acc, best_accuracy)
        save_checkpoint({
            'epoch': epoch + 1,
            'arch': args.arch,
